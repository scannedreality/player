...
class DescriptorSet0 : public vis::VulkanDescriptorSet {
 public:
  ...
  /// Updates the descriptor "State" (binding 0) in this set with the given value.
  void UpdateState(
      const VkDescriptorBufferInfo* State);
  
  /// Updates the descriptor "Output" (binding 1) in this set with the given value.
  void UpdateOutput(
      const VkDescriptorBufferInfo* Output);
};
